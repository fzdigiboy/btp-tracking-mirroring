    ...
    return (
        <div className="group flex flex-col overflow-hidden rounded-xl border border-border bg-card shadow-sm transition-shadow duration-300 hover:shadow-lg">
            ...
            <div className="flex flex-1 flex-col p-4">
                ...
                <button className="mt-4 flex w-full items-center justify-center rounded-lg h-10 px-4 bg-primary/10 text-primary text-sm font-bold transition-colors duration-300 group-hover:bg-primary group-hover:text-white">
                    View Project
                </button>
            </div>
        </div>
