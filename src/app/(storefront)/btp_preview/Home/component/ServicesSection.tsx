  ...
  const services = [
    {
      ...
      description:
        'Securely acquire property and navigate all legal requirements with our expert guidance.',
    },
    {
      icon: '✏️',
      title: 'Architectural & Engineering',
      description:
        'From initial sketches to detailed blueprints, we bring your vision to life with precision.',
    },
    {
      icon: '🏗️',
      title: 'Turnkey Construction',
      description:
        'We manage every phase of construction, ensuring quality and timely delivery of your project.',
    },
  ]
