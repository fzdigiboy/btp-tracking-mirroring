export default function VideoPlayer() {
    const mainVideo = "https://lh3.googleusercontent.com/aida-public/AB6AXuBKbgL54cuLnTBH10QnQw3H5w2ejnr9b-hflf3_hQI_QM42fem91BVW68v_tDj2EhDrpPdQRuXQviUZxCpgj_q5jiOZezdQNkA6tzqADQ0KBi-B2iW2noqOgP4oJA4KX5OwF7kPwl33Ua4eRqsLTv1sRJTpPbvwufKnaZHWD0RtxKPoodm-MSpw7f4MHlaEWaUpmhzmU8JvFErolXHprsg0bJZab29weODxdO9F-Vk2Nw_bqqK_ZNeHlQ61tAyVlpj4qUEp7rsX-t9I";
    ...
    return (
        <div className="mb-12">
            <div className="grid grid-cols-12 gap-4 h-auto md:h-[600px]">
                {/* Main Video */}
                <div className="col-span-12 md:col-span-8 h-full overflow-hidden rounded-xl relative">
                    <div
                        className="relative w-full h-full flex items-center justify-center bg-slate-800 bg-cover bg-center aspect-video rounded-xl overflow-hidden shadow-lg"
                        style={{ backgroundImage: `url("${mainVideo}")` }}
                    >
                        <div className="absolute inset-0 bg-black/30" />
                        <button className="relative flex shrink-0 items-center justify-center rounded-full size-16 bg-white/20 text-white backdrop-blur-sm hover:bg-white/30 transition-colors">
