export default function ProcessTimeline() {
    const steps = [
        ...
        { icon: "📍", title: "Land Secured" },
        { icon: "✏️", title: "Design Approved" },
        { icon: "🏗️", title: "Construction Start" },
        { icon: "🏠", title: "Project Completion" },
        { icon: "🔑", title: "Key Handover" }
    ];

    return (
        <section className="py-20 mx-auto px-4 md:px-8 lg:px-14 mt-16">
